...
# This vendored module follows the ColorVideoVDP implementation. HDRPU21
# provides the PU21 perceptually uniform HDR encoding used in the
# display-aware preprocessing path.
from pycvvdp.algorithm import HDRPU21
...
class vvdp_display_photometry:
    ...
    def linear_2_target_colourspace(self, RGB_lin, target_colorspace):        
        ...
        if target_colorspace=="Y":
            ...
            elif target_colorspace=="RGB2020" or target_colorspace=="RGB2020pq" or target_colorspace=="RGB2020pu21":
            ...
            if target_colorspace=="logLMS_DKLd65":
                ...
                ABC = lin2pq(ABC)
            elif target_colorspace=="RGB2020pu21":
                ABC = pu21.encode_tensor(ABC) / torch.tensor(595.39 + 1e-3, device=ABC.device, dtype=ABC.dtype)

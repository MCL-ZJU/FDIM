...
class YUVReader:
    ...
    def __init__(self, file_name, width=None, height=None, bit_depth=None, fps=None, color_space=None, chroma_ss=None):        
        ...
        if height is not None:
            vprops["height"] = height
        if bit_depth is not None:
            vprops["bit_depth"] = bit_depth
        if fps is not None:
            vprops["fps"] = fps
        if color_space is not None:
            vprops["color_space"] = color_space
        if chroma_ss is not None:
            vprops["chroma_ss"] = chroma_ss
...
class video_source_yuv_file(video_source_dm):
    ...
    def __init__( self, test_fname, reference_fname, display_photometry='standard_4k', frames=-1, full_screen_resize=None, resize_resolution=None, retain_aspect_ratio=False, verbose=False, width=None, height=None, bit_depth=None, fps=None, color_space=None, chroma_ss=None ):

        self.reference_vidr = YUVReader(reference_fname, width=width, height=height, bit_depth=bit_depth, fps=fps, color_space=color_space, chroma_ss=chroma_ss)
        self.test_vidr = YUVReader(test_fname, width=width, height=height, bit_depth=bit_depth, fps=fps, color_space=color_space, chroma_ss=chroma_ss)
